...
const Veiculos = () => {
  ...
  const [openEditar, setOpenEditar] = useState(false);
    ...
    async function criar() {
      ...
      const req = await fetch("http://localhost:8000/veiculos", {
        method: "post",
        headers: {
    ...
    async function editar() {
      ...
      const req = await fetch(`http://localhost:8000/veiculos/${idEditar}`, {
        method: "put",
        headers: {
          "content-type": "application/json"
        },
    ...
    async function deletar(id) {
      ...
      const req = await fetch(`http://localhost:8000/veiculos/${id}`, {
        method: "delete",
        headers: {
          "content-type": "application/json"
        },
